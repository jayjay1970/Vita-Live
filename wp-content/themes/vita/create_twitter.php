...
class creare_twitter {
	public $screen_name = "vitainsure";
	public $not = 1;
	public $cachefile = "twitter.txt";
	public $consumerkey = "BXMLB7HWiRdByK7GGE1aAjdoK";
	public $consumersecret = "FqIDMQMD6gaY1FsLQKixCTEYfosDksA1hHYUpMvpmYZIrfoW0X";
	public $accesstoken = "4404377009-ZyTsrBAq9wxsakt0e2QJcCwrCX3v6ZVhx3fOPn4";
	public $accesstokensecret = "wJA6FejuvNw2hDiUa3sY4u2MfbpvG31eafld990cGAQh9";
