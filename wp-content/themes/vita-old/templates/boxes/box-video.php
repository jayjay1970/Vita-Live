<?php
    ...
    $uniquevideoID = uniqid();

?>

<a href="#" data-featherlight="#openvideo<?php  echo $uniquevideoID; ?>">

    <div class="page-box page-box--video" style="background: url(<?php the_field('video_background_image'); ?>); background-position: 0 0; background-size:cover; background-repeat: no-repeat;">
...
<div id="openvideo<?php  echo $uniquevideoID; ?>" class="page-box__video-container">

    <div class='embed-container'><iframe src='https://player.vimeo.com/video/<?php the_field('add_video_url'); ?>' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
